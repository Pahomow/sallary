...
//
const ProjectManagerForm = ({initialValues , getCurrentPmProjectsAsyncList , getPmAsyncSelector , addPmButtonAsync , removePmButtonAsync}) => {
  ...
  return (
      ...
      >
        {({ values, errors, isSubmitting }) => (
          ...
          <Form>
            <Box>
                <SelectorForm label="Project manager" name="select" selector={values.name}/>
            </Box>
            <Box>
